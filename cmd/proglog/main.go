...
func setupFlags(cmd *cobra.Command) error {
	...
	cmd.Flags().Bool("bootstrap", false, "Boostrap the cluster.")
	...
	cmd.Flags().String("peer-tls-cert-file", "", "Path to server tls cert.")
	cmd.Flags().String("peer-tls-key-file", "", "Path to server tls key.")
	cmd.Flags().String("peer-tls-ca-file", "", "Path to server certificate authority.")
...
func (c *cli) setupConfig(cmd *cobra.Command, args []string) error {
	...
	c.cfg.ServerTLSConfig.CertFile = viper.GetString("server-tls-vert-file")
	...
	c.cfg.PeerTLSConfig.CertFile = viper.GetString("peer-tls-vert-file")
